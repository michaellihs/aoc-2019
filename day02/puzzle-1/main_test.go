...
func TestReadInput(t *testing.T) {
	program, err := ReadInput("/Users/mimi/workspace/learning/adventofcode/day02/puzzle-1/test-input.txt")
	assert.Equal(t,nil, err)
	assert.Equal(t, []int {1,9,10,3,2,3,11,0,99,30,40,50}, program)
}
...
func TestStepCode_returns_error_for_unknown_opcode(t *testing.T) {
	faultyProgram := []int {3,9,10,3,2,3,11,0,99,30,40,50}
